...
export const UrlTool: React.FC = () => {
    const tool = toolRegistry.find(t => t.id === 'url')!;
    const [input, setInput] = usePersistentState('url_input', 'https://example.com/search?q=hello world');
    const [mode, setMode] = usePersistentState('url_mode', 'encode'); // 'encode' | 'decode'
    ...
    const output = useMemo(() => {
        try {
            ...
            return 'Error: Invalid URI sequence';
        }
    }, [input, mode]);
                    ...
                    <div className="flex-1 flex flex-col gap-4">
                        <div className="flex flex-col gap-2 flex-1">
                            ...
                            <textarea
                                ...
                                placeholder={mode === 'encode' ? 'Type text here...' : 'Paste URL encoded string here...'}
                            />
                        </div>
